...
function celsius() {
  if ($("#myform").valid()) {
    ...
    document.forms["myform"].elements["conversion"].value = ("Temperature in Celsius is " str(tempC));
  }
}
...
function fahrenheit() {
  if ($("#myform").valid()) {
    ...
    // display Fahrenheit temperature
    document.forms["myform"].elements["conversion"].value = ("Temperature in Fahrenheit is " + str(tempF));
  }
}
